                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="note-block-actions text-end">
                                        <a title="add note" class="text-primary openModalButton" href="#" onclick="openNoteModal('{{ $customer }}')"><i class="fa-solid fa-plus"></i></a>
                                    </div>
                                    <div class="row" id="notes-container-{{ $customer }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="newNoteForm">
                        ...
                        <input type="hidden" id="identifier" name="identifier" value="customer">
